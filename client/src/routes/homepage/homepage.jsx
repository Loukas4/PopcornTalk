...
return (
   <div>
    ...
    <div className="w-full max-w-2xl flex shadow-2xl rounded-full overflow-hidden bg-white p-2 border border-gray-300 mb-16">
        ...
        {/* Sign In Button */}
    <div> <Link to="/auth"> <button className="bg-gray-900 text-white px-8 py-3 rounded-full font-bold hover:bg-gray-800 transition-colors absolute top-12 right-0 top-36">Sign In</button></Link></div>
